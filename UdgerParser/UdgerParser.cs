...
namespace Udger.Parser
{
    public class UdgerParser
    {
        ...
        private DataTable clientRegex;
        private DataTable osRegex;
        private DataTable device;
        ...
        {
            dt.connect(this);
            this.clientRegex = dt.selectQuery(@"SELECT class_id,client_id,regstring,name,name_code,homepage,icon,icon_big,engine,vendor,vendor_code,vendor_homepage,uptodate_current_version,client_classification,client_classification_code
            ...
            this.osRegex = dt.selectQuery(@"SELECT os_id,regstring,family,family_code,name,name_code,homepage,icon,icon_big,vendor,vendor_code,vendor_homepage
                                              FROM udger_os_regex
                                              JOIN udger_os_list ON udger_os_list.id = udger_os_regex.os_id
                                              ORDER BY sequence ASC");

            this.device = dt.selectQuery(@"SELECT deviceclass_id,regstring,name,name_code,icon,icon_big
